...
I used document.createElement() to create new elements like <li> and <button>. Then added content using textContent, and finally used .append() to add them to the cart.
